        ...
        try {
            switch (req.getRequestType()) {
                ...
                case RequestDTO.GET_CHATS_BY_PROJECT_AND_STAFF:
                    resp = listUtil.getMessagesByProjectAndStaff(req.getProjectID(), req.getCompanyStaffID());
                    break;
...
//                    dataUtil.removeInvoiceItem(req.getInvoiceItem());
                ...
                case RequestDTO.GET_LOCATION_TRACK_BY_STAFF_IN_PERIOD:
                    resp = listUtil.getLocationTracksByStaffInPeriod(
                            req.getCompanyStaffID(), req.getStartDate(), req.getEndDate());
                    break;
                case RequestDTO.GET_LOCATION_TRACK_BY_STAFF:
                    resp = listUtil.getLocationTracksByStaff(req.getCompanyStaffID());
                    break;
