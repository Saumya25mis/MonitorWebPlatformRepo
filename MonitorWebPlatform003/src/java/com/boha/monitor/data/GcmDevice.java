...
@NamedQueries({
    ...
    @NamedQuery(name = "GcmDevice.findByStaff", 
            query = "SELECT g FROM GcmDevice g WHERE g.companyStaff.companyStaffID IN :staffList"),
    ...
    @NamedQuery(name = "GcmDevice.findByRegistrationID", 
            query = "SELECT g FROM GcmDevice g WHERE g.registrationID = :registrationID"),
