...
public class ProjectEngineerDTO implements Serializable {
    ...
    public ProjectEngineerDTO(ProjectEngineer a) {
        this.projectEngineerID = a.getProjectEngineerID();
        engineerID = a.getEngineer().getEngineerID();
        projectID = a.getEngineer().getEngineerID();
