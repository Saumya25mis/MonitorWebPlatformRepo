...
public class ContractorClaimSiteDTO implements Serializable {
    ...
    public ContractorClaimSiteDTO(ContractorClaimSite a) {
        this.contractorClaimSiteID = a.getContractorClaimSiteID();
        this.contractorClaimID = a.getContractorClaim().getContractorClaimID();
        this.projectSite = new ProjectSiteDTO(a.getProjectSite());
    }
