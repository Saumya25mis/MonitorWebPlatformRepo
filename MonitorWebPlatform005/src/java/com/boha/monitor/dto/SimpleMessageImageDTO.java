...
import com.boha.monitor.data.SimpleMessageImage;
...
public class SimpleMessageImageDTO implements Serializable {
    ...
    public SimpleMessageImageDTO(SimpleMessageImage a) {
        this.simpleMessageImageID = a.getSimpleMessageImageID();
        url = a.getUrl();
        secureUrl = a.getSecureUrl();
        dateAdded = a.getDateAdded().getTime();
        simpleMessageID = a.getSimpleMessage().getSimpleMessageID();
    }
