...
public class ProjectStatusDTO implements Serializable {
    ...
    public ProjectStatusDTO(ProjectStatus a) {
        this.projectStatusID = a.getProjectStatusID();
        ...
        if (a.getStatusDate() != null) {
         ...
         if (a.getProjectStatusType() != null) {
             projectStatusType = new ProjectStatusTypeDTO(a.getProjectStatusType());
         }
    }
