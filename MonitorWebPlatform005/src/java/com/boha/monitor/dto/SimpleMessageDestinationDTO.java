...
public class SimpleMessageDestinationDTO implements Serializable {
    ...
    public SimpleMessageDestinationDTO(SimpleMessageDestination a) {
        this.simpleMessageDestinationID = a.getSimpleMessageDestinationID();
