package com.boha.monitor.util.xmpp;
...
//                    }
    ...
    //GCM Server API Key: AIzaSyCz_2aFIPJj7kGW8xdj2cXkasjCVOGa3u8
    // SenderID: 635788281460
    static final String SENDER_ID = "635788281460", API_KEY = "AIzaSyCz_2aFIPJj7kGW8xdj2cXkasjCVOGa3u8";

    public static CcsClient prepareClient(boolean debuggable) {
        synchronized (CcsClient.class) {
            if (sInstance == null) {
                sInstance = new CcsClient(SENDER_ID, API_KEY, debuggable);
            }
        }
        return sInstance;
    }
    ...
    public void handleNackReceipt(Map<String, Object> jsonObject) {
        String messageId = jsonObject.get("message_id").toString();
        String from = jsonObject.get("from").toString();
        logger.log(Level.INFO, "handleNackReceipt() from: {0}, messageId: {1}", new Object[]{from, messageId});
    }
    ...
    public void connect() throws XMPPException {
        ...
        logger.log(Level.INFO, "logged in: {0}", mProjectId);
    }
    ...
    public static void main(String[] args) {
        ...
        final String toRegId = "p9d8yhap89yqjenrp9083h;nf;iewjf;iqnweiur";

        CcsClient ccsClient = CcsClient.prepareClient(true);
